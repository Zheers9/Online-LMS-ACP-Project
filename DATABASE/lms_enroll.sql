...
CREATE TABLE `enroll` (
  ...
  CONSTRAINT `enroll_ibfk_1` FOREIGN KEY (`student_ID`) REFERENCES `user` (`user_ID`) ON DELETE CASCADE,
...
INSERT INTO `enroll` VALUES (1,13,1,'2024-10-13'),(2,13,2,'2024-10-13'),(3,14,1,'2024-10-13');
